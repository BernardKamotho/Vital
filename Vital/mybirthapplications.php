...
<body>
   ...
   <section class="row">
   	    ...
   	    <div class="col-md-12">
               ...
               $ReadSql = "SELECT * FROM `birthcertificat_app_form` WHERE who_saved = '$username' and status = 'Approved'";
               
  
               if (!empty($_POST) and $_POST['notification_no'] != '') {
                 $ReadSql = "SELECT * FROM `birthcertificat_app_form` WHERE who_saved = '$username' and status = 'Approved' and notification_no ='".$_POST['notification_no']."'";
               }


                if (!empty($_POST) and $_POST['applicant_idno'] != '') {
                 $ReadSql = "SELECT * FROM `birthcertificat_app_form` WHERE who_saved = '$username' and status = 'Approved' and applicant_idno ='".$_POST['applicant_idno']."'";
               }
