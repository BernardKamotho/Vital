   	    ...
   	    <div class="col-md-12">
             ...
             <i>Filter by;</i>
              ...
              if (empty($_POST['end'])) {
               ...
               $ReadSql = "SELECT * FROM `deathcertificate_form` WHERE status = 'Not Approved' AND user_applied ='Applied'";
               

               if (!empty($_POST) and $_POST['deceased_idno'] != '') {
                 $ReadSql = "SELECT * FROM `deathcertificate_form` WHERE status = 'Not Approved' AND user_applied ='Applied' and deceased_idno ='".$_POST['deceased_idno']."'";
               }


                if (!empty($_POST) and $_POST['permit_number'] != '') {
                 $ReadSql = "SELECT * FROM `deathcertificate_form` WHERE  status = 'Not Approved' AND user_applied ='Applied' and permit_number ='".$_POST['permit_number']."'";
                }

                if (!empty($_POST) and $_POST['start'] != '' and $_POST['end'] != '') {
                 $ReadSql = "SELECT * FROM `deathcertificate_form` WHERE  status = 'Not Approved' AND user_applied ='Applied' and dod  BETWEEN '".$_POST['start']."' 
                 AND '".$_POST['end']."' ";
                }
               ...
               $res = mysqli_query($connection, $ReadSql); 
                ...
                echo "Showing $count Records. Certificate requested by user";
                  ...
                  echo "<table class='table'>";
                    ...
                    while($r = mysqli_fetch_assoc($res)){
                            ...
                            href=approve_deaths.php?id=$id>Approve/Generate Certificate</span></a></td>";
                                }
                          echo "</tr>"; 
