       ...
       <div class="col-md-1">
        ...
        <div class="col-md-10">
            ...
            <input type="alphanumeric" name="permit_number" placeholder="enter burial permit/death notification"   required="" class="form-control"><br>
                ...
                <label> <b> REPORTED ADDRESS</b></label>
 <input type="text" name="chfaddess" placeholder="enter address" size="50px" required="" class="form-control"><br>
              ...
              <input type="text" name="desurname" placeholder="enter surname/teribal name of deceased" size="50px" required="" class="form-control"><br>
                      ...
                      <div class="col-md-4">
                         ...
                         <textarea cols="40" rows="5" name="cause_a" required="" class="form-control"></textarea>
                         <br>
                      ...
                      <br>
                         ...
                         <label> <b> NAME OF PATHOLOST </b></label>
