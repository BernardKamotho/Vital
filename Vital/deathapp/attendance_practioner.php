   ...
   <section class="row">
   	   <div class="col-md-1">
   	    ...
   	    <div class="col-md-10">
             ...
             <i class="text-danger">To be used only by a Registered or Licensed Medical Practitioner who has been in attendance
during the deceased’s last illness, and to be forwarded by him forthwith to the Registrar of Deaths
either direct or in such other manner as the Registrar may prescribe)</i>
                      ...
                      <div class="col-md-4">
                       ...
                       <label> <b> RELIGION</b></label>
                         ...
                         <label> <b> APPARENT CAUSE OF DEATH</b></label>
                             <label> <b> I<br> Disease or condition directly leading to death</b></label>
                    <input type="text" name="cause_a" placeholder="enter"  required="" class="form-control"><br><br>

                   <label> <b> antecedent causes, morbid conditions,<br> if any giving  rise to the above cause,<br>stating the underlying condition last</b></label>
                   <input type="text" name="cause_b" placeholder="enter"  required="" class="form-control"><br><br>

                     <label> <b>II <br> other significant conditions contributing to the death,<br>but not related to the disease or condition causing it</b></label>

             <input type="text" name="other_conditions" placeholder="enter "  required="" class="form-control"><br>
                ...
                $reg_date  = date("y/m/d");
                   ...
                   $sql = "INSERT INTO `deathcertificate_form`(`deceased_idno`,`permit_number`, `defname`, `demname`, `desurname`, `dod`, `gender`, `age`, `street`, `town`,`hospital`, `cause_a`, `cause_b`, `other_conditions`, `next_of_kin_id`, `practioner_name`, `date_rvd`) 
                VALUES ('$deceased_idno','$permit_number','$defname','$demname','$desurname','$dod','$gender','$age','$street','$town','$hospital','$cause_a','$cause_b','$other_conditions','$next_of_kin_id','$practioner_name','$date_rvd')";
